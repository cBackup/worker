...
import ssh.FactoryMethodSsh;


/**
 * Worker class for SSH protocol
 */
public final class WorkerSsh extends AbstractWorker
{
     ...
     */
    public WorkerSsh(Map<String, String> coordinates, Map<String, String> settings, Map<String, DTOVariableConvertResult> variables)
    {
    ...
    protected Boolean executeJobs()
    {
         ...
         */
        FactoryMethodSsh factory = new FactoryMethodSsh();
        AbstractProtocol sshExecutor = factory.getProtocolObject(this.coordinates, this.settings, this.credentials, this.jobs, this.variables);

        if(sshExecutor !=null) {

            DTOProtocolResult protocolResult = sshExecutor.execute();
             ...
             */
            String getExecutorMessage = "Task " + this.coordinates.get("taskName") + ", node " + this.coordinates.get("nodeId") + ": can't get SSH executor class from factory.";
